...
const FEATURES = [
  { icon: "🗳️", title: "Community Voting", desc: "Upvote reports, confirm declines, and add your own. This is your platform — powered by the crowd, not corporations." },
  { icon: "📉", title: "Quality Timelines", desc: "Year-by-year visual history of how products declined. See exactly when they peaked and who reported it." },
            ...
            <Fade key={item.name} delay={200 + i * 120}>
              <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 16, padding: "18px 20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 10 }}>
                  <span style={{ fontFamily: C.mono, fontSize: 10, color: C.dim }}>Community score</span>
                </div>
