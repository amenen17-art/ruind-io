...
export default function RuindLanding() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.body, fontFamily: C.sans, overflowX: "hidden" }}>
      ...
      <section style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "120px 24px 60px", position: "relative" }}>
...
ENDOFFILEcat > src/App.jsx << 'ENDOFFILE'
import { useState, useEffect, useRef } from "react";
