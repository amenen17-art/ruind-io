...
function ThankYouView({ email, queuePosition, onShare }) {
  ...
  const tweetText = encodeURIComponent(`I just joined the @ruindio waitlist — it's a community tracking every product that got smaller, worse, and more expensive. You already know something's been ruined. Now we're documenting it. 👀\n\nJoin here: ${referralLink}`);
